...
4. If asked to *update* a plan or best-practises file, edit only files under `rebuild.md`, `rebuild/docs/plans/`, and `rebuild/docs/best-practises/`. Never touch `rebuild/backend/`, `rebuild/frontend/`, or `rebuild/infra/`.
